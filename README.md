...
在本地读懂文件内容，自动归类到「生活 / 工作」目录树；用自然语言搜索已归档文件。分类与计费由 DocMind 云端 API 提供，**用户无需自备 AI API Key**。
...
| 套餐 | 价格 | 适合人群 | 核心权益 |
|------|------|----------|----------|
| **免费版** | ¥0 / 月 | 轻度试用 | 每月 **5 次整理** + **20 次搜索** |
| **按次** | 整理 ¥2/次<br>搜索 ¥0.05/次 | 偶尔使用 | 超出免费额度后按次扣费 |
| **月度订阅** | **¥9.9 / 月** | 高频使用、职场人 | **无限次**整理 + 搜索 |
| **年度订阅** | **¥99 / 年**（规划中） | 重度用户 | 约 ¥8.3/月，省 16% |

> 💡 对比同类工具（如 Sortio 等月费 ¥100+ 档），DocMind 定价更亲民，且支持按内容理解与归档后检索。

- `preview`（预览整理）与 `rebuild-index`（重建索引）**始终免费**
